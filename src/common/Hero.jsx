...
// //   return (
// //     <section className="relative bg-[#FBF7F2] pb-24">
// //       {/* ---------- HERO SLIDER ---------- */}
// //       <div className="relative overflow-hidden rounded-b-[40px] shadow-2xl">
// //         <div
...
// //             <div
// //               key={i}
// //               className="min-w-full h-[60vh] sm:h-[70vh] lg:h-[80vh] relative"
// //             >
// //               <img
// //                 src={img}
...
// //             An Experience of Taste, Nature & Elegance
// //           </h1>

// //           <p className="mt-4 text-white/90 text-base sm:text-lg md:text-xl font-['Poppins'] max-w-2xl">
// //             Nature-inspired fine dining, crafted for unforgettable moments
// //           </p>
...
// //               }
// //               className="bg-[#6B3E2E] text-white px-10 py-4 rounded-full font-semibold hover:bg-[#5FAF4E] transition shadow-lg"
// //             >
// //               Reserve Table
// //             </button>
...
// //             <Link
// //               to="/delivery"
// //               className="border-2 border-white text-white px-10 py-4 rounded-full font-semibold hover:bg-white hover:text-[#6B3E2E] transition shadow-lg"
// //             >
// //               Order Online
// //             </Link>
// //           </div>
...
// //       {/* ---------- HERO ACTION CARDS ---------- */}
// //       <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
// //         <button
// //           onClick={() =>
// //             openReservation({ restaurantName: "TERRA DINE N WINE" })
// //           }
// //           className="bg-white rounded-3xl p-6 hover:shadow-xl transition text-center"
// //         >
// //           <img
// //             src="/Hero/MapPin.png"
...
// //             alt=""
// //           />
// //           <p className="font-semibold text-[#6B3E2E]">Reserve Table</p>
// //         </button>

// //         {[
// //           { icon: "/Hero/Gift.png", title: "Happiness Cards", link: "/happiness-cards" },
// //           { icon: "/Hero/Catering.png", title: "Catering", link: "/catering" },
// //           { icon: "/Hero/Truck.png", title: "Order Online", link: "/delivery" },
// //         ].map((item, i) => (
// //           <Link
// //             key={i}
// //             to={item.link}
...
// //               alt=""
// //             />
// //             <p className="font-semibold text-[#6B3E2E]">{item.title}</p>
// //           </Link>
// //         ))}
// //       </div>
// //     </section>
...
//   /* ---------- PRELOAD ALL IMAGES (NO WHITE FLASH) ---------- */
//   useEffect(() => {
//     let loadedCount = 0;
...
//       {/* ---------- HERO ---------- */}
//       <div className="relative h-[60vh] sm:h-[70vh] lg:h-[80vh] rounded-b-[40px] overflow-hidden shadow-2xl bg-black">
        
//         {/* IMAGES (CROSSFADE – NO SLIDE GAP) */}
//         {heroImages.map((img, i) => (
//           <div
//             key={i}
...
//           className="bg-white rounded-3xl p-6 hover:shadow-xl transition text-center"
//         >
//           <img src="/Hero/MapPin.png" className="w-12 h-12 mx-auto mb-4" alt="" />
//           <p className="font-semibold text-[#6B3E2E]">Reserve Table</p>
//         </button>
